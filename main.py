...
def list_available_scripts(full: bool = False):
    ...
    console.print("\n")
    console.print(
        Panel.fit("[bold cyan]Sandbox - Available Scripts[/bold cyan]", border_style="cyan")
    )
    console.print("\n")
...
def main():
    ...
    parser.add_argument(
        "--full", action="store_true", help="Show full module docstrings instead of just summaries"
    )
